...
public:
    ...
    virtual char const *
    name() const = 0;
    virtual GL_Shader_Define_List
    defines() const = 0;

    gl::Shader_Program const &
    program() const {
        return _program;
    }
    ...
    gl::Uniform_Location<glm::vec4>
    locTintColor() {
        return _locTintColor;
    }
...
public:
    ...
    locSunPosition() {
        return _locSunPosition;
    }
    gl::Uniform_Location<glm::mat4>
    locModelMatrix() {
        return _locModelMatrix;
    }
    gl::Uniform_Location<glm::vec3>
    locViewPosition() {
        return _locViewPosition;
    }
